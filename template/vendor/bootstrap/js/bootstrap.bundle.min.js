      ...
      modifiers: {
        ...
        arrow: {
          ...
          fn: function (t, e) {
            ...
            return (
              (b = Math.max(Math.min(a[u] - p, b), 0)), (t.arrowElement = i), (t.offsets.arrow = (z((n = {}), d, Math.round(b)), z(n, c, ''), n)), t
            );
          },
          element: '[x-arrow]'
        },
        ...
        computeStyle: {
          ...
          fn: function (t, e) {
            ...
            return (
              (t.attributes = X({}, _, t.attributes)), (t.styles = X({}, u, t.styles)), (t.arrowStyles = X({}, t.offsets.arrow, t.arrowStyles)), t
            );
          },
          gpuAcceleration: !0,
          x: 'bottom',
          ...
          if (
            ...
            if (o || 27 !== e.which) {
              if ((e.preventDefault(), e.stopPropagation(), !o || 27 === e.which || 32 === e.which))
                return (
                  27 === e.which && i.default(n.querySelector('[data-toggle="dropdown"]')).trigger('focus'), void i.default(this).trigger('click')
                );
