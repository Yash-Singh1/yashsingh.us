export const title = 'MermaidJS Default Curves';
export const subtitle = 'List of flowchart curves in MermaidJS';
export const image = '/img/curve-mermaid.png';
export const author = 'Yash Singh';
export const date = 'August 24, 2021';
