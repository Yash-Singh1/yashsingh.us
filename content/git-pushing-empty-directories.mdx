export const title = 'Pushing Empty Directories in Git';
export const subtitle = 'Tips on pushing directories that are empty inside a Git repository';
export const image = '/img/empty-folder-to-github.png';
export const author = 'Yash Singh';
export const date = 'June 14, 2021';
