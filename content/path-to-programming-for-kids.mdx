export const title = 'Path to Programming for Kids';
export const subtitle = 'Learn how to program as a kid!';
export const image = '/img/kids-programming.png';
export const author = 'Yash Singh';
export const date = 'May 6, 2021';
...
- [Roblox Developers](https://developer.roblox.com/en-us/)
...
contribute to open source. Here is a link to their [official book](http://git-scm.com/book/en/v2).
