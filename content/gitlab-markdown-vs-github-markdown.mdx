export const title = 'GitLab Flavored Markdown vs GitHub Flavored Markdown';
export const subtitle = 'A complete comparision between the two markdown syntaxes';
export const image = '/img/gitlab-markdown-vs-github-markdown.png';
export const author = 'Yash Singh';
export const date = 'April 29, 2021';
