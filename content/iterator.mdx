export const title = 'Javascript Custom Iterables';
export const subtitle = 'Building custom Iterables classes using Symbol.iterator';
export const image = '/img/iterator.png';
export const author = 'Yash Singh';
export const date = 'March 26, 2021';
