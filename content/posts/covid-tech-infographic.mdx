...
Over Covid-19, there were many improvements in technology, expecially in the frontend. I created an [infographic](/infographic/tech-covid)
...
the syntax you are using, the list just goes on (they don't even [support `startsWith{:js}`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/startsWith#browser_compatibility)).
