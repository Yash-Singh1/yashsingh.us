export const title = 'Importing Variables';
export const subtitle = 'Import variables that are from other files and not exported';
export const image = '/img/importing-variables.png';
export const author = 'Yash Singh';
export const date = 'April 23, 2021';
