export const title = 'Writing ESLint Rules';
export const subtitle = 'How ESLint rules are structured and how they work';
export const image = '/img/eslint-custom-rules.png';
export const author = 'Yash Singh';
export const date = 'August 10, 2021';
