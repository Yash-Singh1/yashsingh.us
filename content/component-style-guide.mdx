export const title = 'Component Style Guide';
export const subtitle = 'Guide to classifying and seperating components';
export const image = '/img/reactComponents.png';
