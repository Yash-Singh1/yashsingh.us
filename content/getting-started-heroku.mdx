export const title = 'Getting Started with Heroku';
export const subtitle = 'A simple guide to starting up with heroku';
export const image = '/img/github-and-heroku.png';
export const author = 'Yash Singh';
export const date = 'June 1, 2021';
