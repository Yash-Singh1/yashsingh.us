export const title = 'React Router DOM with live-server';
export const subtitle = 'How to use the React Router DOM module with live-server';
export const image = '/img/react-router-dom-with-live-server.png';
